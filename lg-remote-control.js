...
<!-- ################################# COLORED BUTTONS END ################################# -->
                  ...
                  <div class="grid-container-volume-channel-control" >
                      ...
                      <button class="btn-flat flat-high ripple" style="margin-top: 0px; height: 50%;" @click=${() => this._button("Input.Home")}><ha-icon icon="mdi:home"></button>
...
<!-- ################################# MEDIA CONTROL ################################# -->
                 <div class="grid-container-media-control" >
                      ...
                      <button class="btn-flat flat-low ripple"  @click=${() => this._command("media_stop")}><ha-icon icon="mdi:stop"/></button>
